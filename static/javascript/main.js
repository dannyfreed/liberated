...
//aside instagram feed
    var userFeed = new Instafeed({
        get: 'user',
        userId: 3883521,
        accessToken: '3883521.467ede5.473027784a77451692b5821243dadb54',
        limit: '1',
...
//griz instafeed
    ...
    var userFeedMANIC = new Instafeed({
        ...
        get: 'user',
        userId: 215270126,
        accessToken: '215270126.467ede5.c070597d37dc49ce8fc90d9bfbe5f9f3',
        limit: '4',
        resolution: 'standard_resolution',
        template: '<div class="insta-container"> <figure style="margin:0;" id="{{id}}"><a target="_blank" href="{{link}}"><img class="img-responsive insta-pic" src="{{image}}" /></a> <figcaption style="font-size:14px; line-height:18px; text-align:left;"><p>{{caption}}</p><p style="padding-left:1px;"><span class="likes"><a href="{{link}}"><i class="fa fa-heart"></i>{{likes}}</a></span><span class="comments"><a href="{{link}}"><i class="fa fa-comment"></i>{{comments}}</a></span></p></figcaption></figure></div>'
    });
    ...
    target: 'floozies-feed',
        get: 'user',
        userId: 28668659,
        accessToken: '28668659.467ede5.2e6456f6969d40c18a793959dd466b3c',
        limit: '4',
        resolution: 'standard_resolution',
        template: '<div class="insta-container"> <figure style="margin:0;" id="{{id}}"><a target="_blank" href="{{link}}"><img class="img-responsive insta-pic" src="{{image}}" /></a> <figcaption style="font-size:14px; line-height:18px; text-align:left;"><p>{{caption}}</p><p style="padding-left:1px;"><span class="likes"><a href="{{link}}"><i class="fa fa-heart"></i>{{likes}}</a></span><span class="comments"><a href="{{link}}"><i class="fa fa-comment"></i>{{comments}}</a></span></p></figcaption></figure></div>'
    });
...
$('.show-item').each(function(){
    ...
    //if( moment(showdate).isAfter(moment(todaysdate))){

    if(moment().isBefore(moment(showdate))){ //show is still on!   
        $(this).addClass('active-show');
    }
    else{ //show already happened :(
        $(this).addClass('expired');
        $(this).hide();
    }
});

$('section.tickets .active-show').hide().slice(0,6).show();


 //for each show
 ////if data-date isAfter todaysdate
 //////HIDE
 ////else
 //////show
